...
service ProcurementService @(requires: [
    'authenticated-user',
    'Auditor',
    'POManager',
    'POStaff',
...
annotate ProcurementService.GRItems with @Common.SideEffects: {TargetEntities: ['$self'] // This tells the UI to refresh the specific row/table
}
actions {
    markInspected                        @(Common.SideEffects: {TargetEntities: ['$self']})
};
